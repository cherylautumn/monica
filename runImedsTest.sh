...
libpath=$libpath"./lib/JRI.jar:"
libpath=$libpath"./lib/REngine.jar:"
libpath=$libpath"./lib/JRIEngine.jar:"
echo $libpath
java -Xms4056M -Djava.library.path=/Library/Frameworks/R.framework/Resources/library/rJava/jri/   -cp $libpath./target/demo-0.0.2-SNAPSHOT.jar org.imeds.daemon.DemoRJava
