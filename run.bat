...
rem..\spark-1.0.0-bin-hadoop1\spark-1.0.0-bin-hadoop1\bin\spark-submit --class org.imeds.data.LROutlierDataSetWorker --master local[4] target\demo-0.0.1-SNAPSHOT-jar-with-dependencies.jar data\lr-data\random.data 4 3 N Y>>nb.txt
pause